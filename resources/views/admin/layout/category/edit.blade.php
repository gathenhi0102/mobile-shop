...
<head>
    ...
    <title>Xem và chỉnh sửa thể loại</title>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="category_name" placeholder="Nhập tên thương hiệu" required value="{{$category_info->name}}">
                                        </div>  
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label>Mô tả</label>
                                            <textarea name="category_description" class="form-control" rows="3">{{$category_info->description}}</textarea>
                                        </div>  
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-primary">Sửa</button>
                                <a href="{{route('listcategory')}}" type="button" role = "button" class="btn btn-danger">Thoát</a>
                            </fieldset>    
                            </form>        
                        </div>
                        <!-- /.panel-body -->
