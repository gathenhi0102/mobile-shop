                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="trademark_name" placeholder="Nhập tên thương hiệu" required value="{{old('trademark_name')}}">
                                        </div>  
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label>Mô tả</label>
                                            <textarea name="trademark_description" class="form-control" rows="3">{{old('trademark_description')}}</textarea>
                                        </div>  
                                    </div>
                                </div>
