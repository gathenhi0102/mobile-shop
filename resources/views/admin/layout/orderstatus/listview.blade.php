...
<head>
    ...
    <title>Danh sách loại đơn hàng</title>
...
<!-- Page Content -->
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Quản lý trạng thái đơn hàng</h1>
                </div>
                    <!-- /.col-lg-12 -->
            </div>
                <!-- /.row -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <a href="{{route('addorderstatus')}}" type="button" class="btn btn-primary">THÊM TRẠNG THÁI</a>
                </div>
            </div>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover dataTables">
                                ...
                                <tbody>
                                    @foreach($stt_list as $item)
                                    <tr>
                                        <td><a role = "button" href="{{route('editstatus', $item->id)}}">{{$item->id}}</a></td>
                                        <td>{{$item->name}}</td>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-content pull-right">
                                                    <li><a role = "button" href="{{route('editstatus', $item->id)}}"><i class="glyphicon glyphicon-edit"></i> Sửa</a></li>
                                                    <li><a role = "button" class="deletetrademark" href="{{route('deletestatus', $item->id)}}"><i class="glyphicon glyphicon-remove"></i> Xóa</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
