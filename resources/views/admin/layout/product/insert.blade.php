                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="product_name" placeholder="Nhập tên sản phẩm" required value="{{old('product_name')}}">
                                        </div>  
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input id="product_price" class="form-control" name="product_price" placeholder="Nhập giá của sản phẩm" required maxlength="11" value="{{old('product_price')}}">
                                        </div>    
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="3" placeholder="Nhập mô tả cho sản phẩm" name="product_description">{{old('product_description')}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Nhập quà tặng kèm sản phẩm" name="product_gift" value="{{old('product_gift')}}">
                                        </div>   
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Nhập số lượng của sản phẩm" name="product_quantity" id="product_quantity" maxlength="2" required value="{{old('product_quantity')}}">
                                        </div>   
                                    </div>
                                </div>
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>1</td>
                                                        <td>Màn hình</td>
                                                        <td><input type="text" class="form-control inputtable" name="product_screen" value="{{old('product_screen')}}"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>2</td>
                                                        <td>Hệ điều hành</td>
                                                        <td><input type="text" class="form-control inputtable" name="product_os" value="{{old('product_os')}}"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>3</td>
                                                        <td>CPU</td>
                                                        <td><input type="text" class="form-control inputtable" name="product_cpu" value="{{old('product_cpu')}}"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>4</td>
                                                        <td>RAM</td>
                                                        <td><input type="text" class="form-control inputtable" name="product_ram" value="{{old('product_ram')}}"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>5</td>
                                                        <td>Camera</td>
                                                        <td><input type="text" class="form-control inputtable" name="product_cam" value="{{old('product_cam')}}"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>6</td>
                                                        <td>Pin</td>
                                                        <td><input type="text" class="form-control inputtable" name="product_pin" value="{{old('product_pin')}}"></td>
                                                    </tr>  
                                                </tbody>
                                            </table>
                                        </div>
