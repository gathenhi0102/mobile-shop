...
<!-- Page Content -->
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Thêm trạng thái mới</h1>
                </div>
                    <!-- /.col-lg-12 -->
            </div>
                <!-- /.row -->
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="orderstatus_name" placeholder="Nhập tên trạng thái đơn hàng" required value="{{old('orderstatus_name')}}">
                                        </div>  
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label>Mô tả</label>
                                            <textarea name="orderstatus_description" class="form-control" rows="3">{{old('orderstatus_description')}}</textarea>
                                        </div>  
                                    </div>
                                </div>
