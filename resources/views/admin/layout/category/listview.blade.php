...
<!-- Page Content -->
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <a href="{{route('addcategory')}}" type="button" class="btn btn-primary">THÊM THỂ LOẠI</a>
                </div>
            </div>
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover dataTables">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><a role = "button" href="{{route('editcategory', $item->id)}}">{{$item->id}}</a></td>
                                        <td>{{$item->name}}</td>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-content pull-right">
                                                    <li><a role = "button" href="{{route('editcategory', $item->id)}}"><i class="glyphicon glyphicon-edit"></i> Sửa</a></li>
                                                    <li><a href="{{route('deletecategory',$item->id)}}" role = "button" class="deletetrademark"><i class="glyphicon glyphicon-remove"></i> Xóa</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
