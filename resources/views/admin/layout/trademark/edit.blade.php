...
<head>
    ...
    <title>Xem và chỉnh sửa thương hiệu</title>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            @endif
                            <form role="form" action="{{route('posttrademarkinfo')}}" method="post">
                            <fieldset>
                                <input type="hidden" name="_token" value="{{csrf_token()}}">
                                <input type="hidden" name="trademark_id" value="{{$trademark_info->id}}">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label>Tên thương hiệu</label>
                                            <input class="form-control" name="trademark_name" placeholder="Nhập tên thương hiệu" required value="{{$trademark_info->name}}">
                                        </div>  
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label>Mô tả</label>
                                            <textarea name="trademark_description" class="form-control" rows="3">{{$trademark_info->description}}</textarea>
                                        </div>  
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-primary">Sửa</button>
                                <a href="{{route('listtrademark')}}" type="button" role = "button" class="btn btn-danger">Thoát</a>
                            </fieldset>    
                            </form>        
                        </div>
                        <!-- /.panel-body -->
